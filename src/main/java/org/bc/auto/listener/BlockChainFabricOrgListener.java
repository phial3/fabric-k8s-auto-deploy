...
import org.bc.auto.listener.source.FabricOrgEventSource;
...
//          OrgService orgService = SpringBeanUtil.getBean(OrgService.class);
            ...
            //获取需要创建的组织对象
            FabricOrgEventSource fabricOrgEventSource = (FabricOrgEventSource) blockChainEvent.getBlockChainEventSource();
            BCOrg bcOrg = fabricOrgEventSource.getBcOrg();
            ...
            boolean flag = BlockChainShellQueueUtils.add(fabricOrgEventSource);
            if (!flag) {
