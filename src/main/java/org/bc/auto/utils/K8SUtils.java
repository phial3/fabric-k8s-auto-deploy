...
public class K8SUtils {
    ...
    public static boolean createNamespace(String namespace) throws BaseRuntimeException {
        ...
        try {
            new CoreV1Api().createNamespace(body, null, null, null, null);
            return true;
        ...
        try {
            switch (chooseType) {
                case "nameSpace": {
                    for (int i = 0; i < 10; i++) {
                        Thread.sleep(1000L);
                        V1Namespace v1Namespace = coreV1Api.readNamespace(nameSpace, null);
    ...
    public static void createPersistentVolume(String pvName, String nfsHost, String nfsPath, String storageSize) {
        ...
        try {
            new CoreV1Api().createPersistentVolume(v1PersistentVolume, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static void createPersistentVolumeClaim(String namespace, String pvcName, String pvName, String storageSize) {
        ...
        try {
            new CoreV1Api().createNamespacedPersistentVolumeClaim(namespace, v1PersistentVolumeClaim, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static void createPodDisruptionBudget(String namespace, String pdbName, Map<String, String> labels, int maxUnavailable) {
        ...
        try {
            new PolicyV1beta1Api().createNamespacedPodDisruptionBudget(namespace, v1beta1PodDisruptionBudget, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static void createStatefulSet(String namespace, String podName, String svcName, String volumeName, Map<String, String> labels, int replicas, String storageClassName, V1PodSpec spec, String storageSize) {
        ...
        try {
            new AppsV1Api().createNamespacedStatefulSet(namespace, v1StatefulSet, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static void createDeployment(String namespace, String podName, Map<String, String> labels, V1PodSpec spec) {
        ...
        try {
            new AppsV1Api().createNamespacedDeployment(namespace, v1Deployment, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static void createService(String namespace, String svcName, Map<String, String> labels, V1ServiceSpec spec) {
        ...
        try {
            new CoreV1Api().createNamespacedService(namespace, v1Service, null, null, null, null);
        } catch (ApiException e) {
    ...
    public static boolean deletePersistentVolume(String pvName) {
        try {
            V1PersistentVolume v1PersistentVolume = new CoreV1Api().deletePersistentVolume(pvName, null, null, 5, false, null, null);

            // TODO 正常应该将pv对应的物理存储目录也一块删除，目前为了防止误删，先不做此处理，手动去删除
            return v1PersistentVolume.getStatus() == null;
        } catch (ApiException e) {
    ...
    public static boolean deletePersistentVolumeClaim(String pvcName, String namespace, CoreV1Api coreV1Api) {
        // 删除 pvc
        try {
            V1PersistentVolumeClaim v1PersistentVolumeClaim = coreV1Api.deleteNamespacedPersistentVolumeClaim(pvcName, namespace, null, null, null, null, null, null);
            return v1PersistentVolumeClaim.getStatus() == null;
        } catch (ApiException e) {
    ...
    public static boolean deleteService(String svcName, String namespace, CoreV1Api coreV1Api) {
        // 删除service
        try {
            V1Service v1Service = coreV1Api.deleteNamespacedService(svcName, namespace, null, null, null, null, null, null);
            return v1Service.getStatus() == null;
        } catch (ApiException e) {
    ...
    public static boolean cleanAll(String namespace) {
        try {
            ...
            V1beta1PodDisruptionBudgetList v1beta1PodDisruptionBudgetList = policyV1beta1Api.listNamespacedPodDisruptionBudget(namespace, null, null, null, null,null, null, null, null, null, null);
            ...
            V1StatefulSetList v1StatefulSetList = appsV1Api.listNamespacedStatefulSet(namespace, null, null, null, null, null, null, null, null, null, null);
            ...
            // 删除deployment
            V1DeploymentList deployList = appsV1Api.listNamespacedDeployment(namespace, null, null, null, null, null, null, null, null, null, null);
            ...
            // 删除service
            V1ServiceList svcList = coreV1Api.listNamespacedService(namespace, null, null, null, null, null, null, null, null, null, null);
    ...
    public static String queryClusterIp(String svcName, String namespace) {
        try {
            V1Service v1Service = new CoreV1Api().readNamespacedService(svcName, namespace, null);
            // 最长等待两分钟
            final int count = 120;
            for (int i = 0; i <= count; i++) {
    ...
    public static String queryNodeIp() {
        try {
            V1NodeList v1NodeList = new CoreV1Api().listNode(null, null, null, null, null,null, null, null, null, null);
